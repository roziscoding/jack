...
Staying up to date is intentionally simple — security patches ship as ordinary
releases, so staying secure just means bumping to the most recent version tag.
If you're on the latest tag, you have all the fixes.
...
- I'll acknowledge new reports as soon as I can, and keep you posted as I look
  into it.
